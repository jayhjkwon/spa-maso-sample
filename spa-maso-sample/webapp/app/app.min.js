...
!function(factory) {
    ...
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        ...
        define('knockout/knockout',['exports'], factory);
    } else {
...
define('knockout', ['knockout/knockout'], function (main) { return main; });
...
define('sammy', ['sammy/sammy'], function (main) { return main; });

define("sammy/sammy", function(){});
...
define('activity', ['activity/activity-indicator'], function (main) { return main; });

define("activity/activity-indicator", function(){});
...
(function (root, doc, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        define('amplify/amplify',["jquery"], function ($) {
...
define('i18n', ['i18n/i18n'], function (main) { return main; });

define("i18n/i18n", function(){});

define('nls/resources',{
    'root' : {
        'buttonSearch' : 'Search',
        'buttonSave' : 'Save',
        'navReferral' : 'Referral',
        'navPatient' : 'Patients',
        'navDocument' : 'Documents',
        'validationOK' : 'OK!',
        'validationFirstNameRequired' : 'please enter first name',
        'validationFirstNameLength' : 'first name should be at least 2 characters',
        'validationLastNameRequired' : 'please enter last name',
        'validationLastNameLength':'last name should be at least 2 characters'
    },
...
define('nls/nls',['infra/store', 'infra/config', 'i18n!./resources', 'i18n!./ko-kr/resources'],
...
(function (factory) {
	...
	if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
		...
		define('knockout.mapping/knockout.mapping',["knockout", "exports"], factory);
	} else {
...
define('knockout.mapping', ['knockout.mapping/knockout.mapping'], function (main) { return main; });

define('data/referral',
...
define('models/document',['knockout', 'knockout.mapping'],
    function (ko, mapping) {
...
define('models/referral',['jquery', 'knockout', 'knockout.mapping', './document'],
...
define('models/comment',['knockout', 'knockout.mapping', 'moment'],
...
define('models/post',['knockout', 'knockout.mapping', 'moment', './comment'],
...
define('models/models',['./referral', './document', './post', './comment'],
...
define('text!views/top.html',[],function () { return '<div id="nav-div" class="navbar-inner">\r\n    <div class="container-fluid">\r\n        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">\r\n            <span class="icon-bar"></span>\r\n            <span class="icon-bar"></span>\r\n            <span class="icon-bar"></span>\r\n        </a>\r\n        <a class="brand" style="margin: 0 20px;" href="#">Ray\'s Blog</a>\r\n        <ul class="nav">\r\n            <li data-bind="setActive:{}">\r\n                <a href="#"><i class="icon-home"></i>&nbsp;&nbsp;Home</a>\r\n            </li>\r\n            <li data-bind="setActive:{}"><a href="#/post/write"><i class="icon-pencil"></i>&nbsp;&nbsp;New Post</a></li>\r\n            <li data-bind="setActive:{}"><a data-bind="attr: {href : \'#/post/edit/\' + id()}"><i class="icon-edit"></i>&nbsp;&nbsp;Edit Post</a></li>\r\n            <li data-bind="setActive:{}"><a href="#/chat"><i class="icon-comment"></i>&nbsp;&nbsp;Chat</a></li>\r\n            <li class="dropdown">\r\n                <a href="#"  class="dropdown-toggle" data-toggle="dropdown">Language<b class="caret"></b></a>\r\n                <ul class="dropdown-menu">\r\n                    <li><a href="#">English</a></li>\r\n                    <li><a href="#">Korean</a></li>\r\n                </ul>\r\n            </li>\r\n            <li class="divider-vertical"></li>\r\n            <li>\r\n                <div class="navbar-search">\r\n                    <input data-bind="value: searchText, valueUpdate: \'afterkeydown\'" type="text" class="search-query" placeholder="Search">\r\n                </div>\r\n            </li>\r\n\r\n        </ul>\r\n    </div>\r\n</div>\r\n';});

define('text!views/left.html',[],function () { return '<div id="left-div">\r\n    <ul class="nav nav-list" data-bind="foreach: filteredPosts">\r\n        <li data-bind="setActive:{}">\r\n            <a data-bind="attr: {href: url}">\r\n                <label data-bind="text: shortTitle"></label>\r\n                <div class="date-created" >\r\n                    <i class="icon-time"></i><label data-bind="text: yyyymmdd"></label>\r\n                </div>\r\n            </a>\r\n        </li>\r\n    </ul>\r\n</div>\r\n';});

define('text!views/referrals.html',[],function () { return '<section id="referral-div" class="view">\r\n    <h2>Referral</h2>\r\n\r\n    <div>\r\n        <input type="text" data-bind="value: referralName"/>\r\n        <input type="text" data-bind="value: type"/>\r\n        <button id="btnSave" data-bind="click: saveReferral, enable: !isBusy(), text: saveLabel"></button>\r\n        <button id="btnDelete" type="button">delete</button>\r\n        <button id="btnEdit" type="button" data-bind="bsButton: {}">edit</button>\r\n        <button type="button" class="btn btn-primary" data-complete-text="finished!">Single Toggle</button>\r\n        <div class="btn-group pull-right nav-tabs" data-toggle="buttons-radio">\r\n          <button class="btn" value="60">Hour</button>\r\n          <button class="btn" value="1440">Day</button>\r\n          <button class="btn" value="10080">Week</button>\r\n          <button class="btn" value="43200">30 Day</button>\r\n        </div>\r\n        <button id="btnLoading" type="button" class="btn" data-loading-text="loading stuff..." data-bind="loadingButton:{}" >...</button>\r\n    </div>\r\n\r\n    <div>\r\n        <input type="text" data-bind="value: searchText, valueUpdate: \'afterKeydown\', ebable: !isBusy()"\r\n               placeholder="Referral Name, Type"/>\r\n        <button data-bind="button: {labelText: buttonSearch}, click: loadReferrals, enable: !isBusy()"></button>\r\n\r\n        <ul id="referrals" data-bind="foreach: referralList">\r\n            <li>\r\n                <label data-bind="text: id"></label>\r\n                :&nbsp;\r\n                <!--<label data-bind="text: referralName"></label>-->\r\n                <!--<label data-bind="text: \'.\' + type()"></label>-->\r\n                <label data-bind="text: fileName, click: $parent.onFileNameClick"></label>\r\n                <!-- ko if: $data.documents -->\r\n                <ul data-bind="foreach: documents">\r\n                    <li>\r\n                        <!--<label data-bind="text: title"></label>&nbsp;:&nbsp;-->\r\n                        <!--<label data-bind="text: description"></label>&nbsp;&nbsp;-->\r\n                        <label data-bind="text: summary"></label>\r\n                    </li>\r\n                </ul>\r\n                <!-- /ko -->\r\n            </li>\r\n        </ul>\r\n    </div>\r\n</section>\r\n';});

define('text!views/post/detail.html',[],function () { return '<section id="section-post-detail" class="view" data-bind="with: post">\r\n    <div class="page-header">\r\n        <h3 data-bind="text: title"></h3>\r\n    </div>\r\n\r\n    <div class="content" data-bind="text: content"></div>\r\n    <div class="time-created">\r\n        <i class="icon-time"></i>&nbsp;Posted at&nbsp;<b data-bind="text: yyyymmdd"></b>\r\n    </div>\r\n    <div class="tags">\r\n        <i class="icon-tags"></i>\r\n        <!-- ko foreach: tags -->\r\n        <a href="#" class="btn btn-info btn-mini" data-bind="text: $data"></a>\r\n        <!-- /ko -->\r\n    </div>\r\n    <div class="comments">\r\n        <i class="icon-comment"></i>&nbsp;<b>Comments</b>\r\n        <div data-bind="if: comments().length === 0" style="margin-bottom: 10px;">\r\n            <span class="label">No Comments yet.</span>\r\n        </div>\r\n        <table class="table table-hover">\r\n            <tbody data-bind="foreach: comments">\r\n                <tr>\r\n                    <td>\r\n                        <p><b data-bind="text: commenterName"></b>&nbsp;wrote at&nbsp;<em data-bind="text: ago"></em></p>\r\n                        <p data-bind="text: commentText"></p>\r\n                    </td>\r\n                </tr>\r\n            </tbody>\r\n        </table>\r\n    </div>\r\n    <div class="write-comment">\r\n        <div>\r\n            <input data-bind="value: $parent.commenterName" type="text" id="inputName" placeholder="Name">\r\n        </div>\r\n        <div>\r\n            <textarea data-bind="value: $parent.commentText" id="inputComment" rows="10" class="input-block-level" placeholder="Comment here !!"></textarea>\r\n        </div>\r\n        <div>\r\n            <button data-bind="click: $parent.saveComment" type="submit" class="btn btn-primary">Post Comment</button>\r\n        </div>\r\n    </div>\r\n</section>\r\n\r\n';});

define('text!views/post/edit.html',[],function () { return '<section id="section-post-edit" class="view">\r\n    <div class="page-header">\r\n        <h3>Edit Post</h3>\r\n    </div>\r\n    \r\n    <form>\r\n        <div>\r\n            <input data-bind="value: title" type="text" class="input-block-level" placeholder="Title" autofocus />\r\n        </div>\r\n\r\n        <div>\r\n            <textarea data-bind="value: content" class="input-block-level" rows="15"></textarea>\r\n        </div>\r\n        \r\n        <div>\r\n            <input type="text" \r\n                data-provide="typeahead"\r\n                data-bind="typeahead:{}, value: tags"\r\n                class="input-block-level" \r\n                placeholder = "Tag, Use comma delimiter for multiple tags" />\r\n        </div>\r\n\r\n        <div class="form-actions" align="center">\r\n            <button data-bind="click: updatePost" type="button" class="btn btn-primary">Save</button>\r\n            <button data-bind="click: resetPost" type="button" class="btn">Reset</button>\r\n        </div>\r\n    </form>\r\n</section>\r\n';});

define('text!views/post/write.html',[],function () { return '<section id="section-post-write" class="view">\r\n    <div class="page-header">\r\n        <h3>New Post</h3>\r\n    </div>\r\n\r\n    <form>\r\n        <div>\r\n            <input data-bind="value: title" type="text" class="input-block-level" placeholder="Title" autofocus />\r\n        </div>\r\n\r\n        <div>\r\n            <textarea data-bind="value: content" class="input-block-level" rows="15"></textarea>\r\n        </div>\r\n        \r\n        <div>\r\n            <input type="text" \r\n                data-provide="typeahead"\r\n                data-bind="typeahead:{}, value: tags"\r\n                class="input-block-level" \r\n                placeholder = "Tag, Use comma delimiter for multiple tags" />\r\n        </div>\r\n\r\n        <div class="form-actions" align="center">\r\n            <button data-bind="click: writePost" type="button" class="btn btn-primary">Save</button>\r\n            <button data-bind="click: resetPost" type="button" class="btn">Reset</button>\r\n        </div>\r\n    </form>\r\n</section>\r\n';});
...
define('jquery-validation', ['jquery-validation/jquery.validate'], function (main) { return main; });

define("jquery-validation/jquery.validate", function(){});

define('bindings/validate.patient',
...
define('bindings/resizeLeftMain',
...
define('bindings/bindings',['./validate.patient',
        './loadingButton',
        './resizeLeftMain',
        './typeahead',
        './setActive'
...
define('mockJson', ['mockJson/jquery.mockjson'], function (main) { return main; });

define("mockJson/jquery.mockjson", function(){});

define('data/mock/mock.referral',
...
define("jam/bootstrap/docs/assets/js/bootstrap.js", function(){});
